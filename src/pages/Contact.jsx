      ...
      <section className="py-24">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold font-heading mb-6 text-slate-800 dark:text-white">
              Let's Connect
            </h2>
          ...
          <div className="bg-slate-300 dark:bg-slate-800 p-12 md:p-16 rounded-3xl shadow-sm">
            <ContactForm />
          </div>

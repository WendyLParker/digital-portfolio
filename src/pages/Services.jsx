      ...
      <section className="py-24">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold font-heading text-navy-500 mb-6">Our Services</h2>
            <p className="text-xl text-navy-500 dark:text-slate-400 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div className="bg-gray-500 dark:bg-slate-800 p-10 rounded-3xl">
              <h3 className="text-2xl font-semibold mb-6 text-white font-heading">Custom Software Development</h3>
            ...
            <div className="bg-gray-500 dark:bg-slate-800 p-10 rounded-3xl">
              <h3 className="text-2xl font-semibold mb-6 text-white font-heading">Legacy System Modernization</h3>
              <p className="text-white">
            ...
            <div className="bg-gray-500 dark:bg-slate-800 p-10 rounded-3xl">
              <h3 className="text-2xl font-semibold mb-6 text-white font-heading">Application Support</h3>
              <p className="text-white">
            ...
            <div className="bg-gray-500 dark:bg-gray-500 p-10 rounded-3xl">
              <h3 className="text-2xl font-semibold mb-6 text-white font-heading">AWS Cloud & Serverless Solutions</h3>
              <p className="text-white">
